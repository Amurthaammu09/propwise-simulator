...
const features = [
  ...
  },
  {
    ...
    description:
      "Detailed financial model with cost estimates, projected revenue, and optimized financing options.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
  ...
  {
    title: "Material & Construction Costs",
    description:
      "Predict required materials and cost variations over time to improve budgeting.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
...
const FeatureSection = () => {
  ...
  useEffect(() => {
    ...
    const elements = featureRef.current?.querySelectorAll(".animate-on-scroll");
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-100 mt-4 font-semibold">
            Reimagine Your Investment Strategy
          </h2>
          <p className="animate-on-scroll opacity-0 translate-y-10 transition-all duration-700 delay-200 mt-4 text-zinc-600 dark:text-zinc-300 max-w-2xl mx-auto">
            Our AI-powered platform provides comprehensive tools to optimize every aspect of your real estate investment decisions.
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            <div
              ...
              className={cn(
                ...
                `delay-${Math.min(300 + index * 100, 800)}`
              )}
            >
              <div className="p-6 rounded-xl glass-card hover-card-animation h-full">
                <div className="w-12 h-12 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center mb-4 text-zinc-900 dark:text-white">
                  {feature.icon}
                </div>
